...
//#endif
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Exercício 5D - Criado por Bruno Silva da Silva", nullptr, nullptr);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform4f(colorLoc, 0.3f, 0.3f, 0.7f, 1.0f); //enviando cor para variável uniform inputColor
        ...
        glUniform4f(colorLoc, 0.5f, 1.0f, 0.4f, 1.0f);
